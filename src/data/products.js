export const productDataset = {
  products: [
    ...
    },
    {
      ...
      description: "Versatile eyeshadow shades with built-in mirror for on-the-go application.",
      category: 'beauty',
      price: 19.99,
    ...
    },
    {
      id: 4,
      title: 'Red Lipstick',
      description: 'A classic and bold choice lipstick with creamy, pigmented formula.',
      category: 'beauty',
      price: 12.99,
    ...
    },
    {
      ...
      description: 'Rich and glossy red nail polish with quick-drying formula.',
      category: 'beauty',
      price: 8.99,
    ...
    },
    {
      ...
      description: "CK One is a classic unisex fragrance known for its fresh and clean scent.",
      category: 'fragrances',
      price: 49.99,
    ...
    },
    {
      ...
      description: 'An elegant and mysterious fragrance with grapefruit and sandalwood notes.',
      category: 'fragrances',
      price: 129.99,
    ...
    },
    {
      id: 8,
      title: "Dior J'adore",
      description: "Luxurious floral fragrance with ylang-ylang, rose and jasmine.",
      category: 'fragrances',
      price: 89.99,
    ...
    },
    {
      ...
      description: 'Vibrant and fruity fragrance with mango and jasmine notes.',
      category: 'fragrances',
      price: 69.99,
    ...
    },
    {
      ...
      description: "Floral and captivating fragrance with tuberose and jasmine.",
      category: 'fragrances',
      price: 79.99,
...
export function fetchProducts(skip = 0, limit = 10) {
  return Promise.resolve({
    products: productDataset.products.slice(skip, skip + limit),
    total: productDataset.total,
  });
}
    {
      id: 5,
